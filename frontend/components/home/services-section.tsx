    ...
    <section className="bg-background py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-10 max-w-2xl text-center md:mb-12">
          <Reveal as="p" className="text-sm font-bold text-primary/70 tracking-wide uppercase">Our Services</Reveal>
          <TextReveal
            as="h2"
            className="mt-2 font-serif text-2xl font-bold text-foreground sm:text-3xl md:text-4xl"
            text="Comprehensive Dental Care"
          />
          <Reveal as="p" delay={150} className="mt-3 text-sm text-muted-foreground md:mt-4 md:text-base">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            <Reveal key={index} direction="up" delay={(index % 4) * 100} scale className="h-full">
        ...
        <Reveal delay={150} className="mt-10 text-center md:mt-12">
